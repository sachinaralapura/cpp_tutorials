...
void Text(const char text[], int x, int y, int z)
{
    // The color
    glColor3f(1, 1, 1);
...
void printLines(const char** s, int offsetY, int n, int x, int y)
{
    int i = 0;
    for (; i < n; i++)
    {
...
void MainScene1()
{
    ...
    const char* name1[] = { "The Enola Gay (Model number B-29-45-MO, Serial number 44-86292, Victor number 82) was built by the Glenn L. Martin Company (later part of",
...
void MainScene2()
{
    ...
    const char* name1[] = { "At the time of its bombing, Hiroshima was a City of industrial and military significance. A number of military units were located nearby,",
...
void MainScene3()
{
    ...
    char h1[] = "Scene 3";
    char h2[] = "LITTLE BOY";
    const char* name1[] = { "'Little Boy' was the codename for the type of atomic bomb dropped on the Japanese City of Hiroshima on 6 August 1945 during World War II.",
...
void MainScene4()
{
    ...
    const char* name1[] = { "People on the ground reported a pika —a brilliant flash of light—followed by a don —a loud booming sound.Some 70,000–80,000 people, around",
...
void MainScene5()
{
    ...
    glClearColor(1.0, 1.0, 1.0, 1.0);
    char h2[] = "CONCLUSION";
    const char* name1[] = { "As a result of the atomic bombing on August 6th, 1945, Hiroshima City was completely destroyed, losing many medical facilities and medical",
